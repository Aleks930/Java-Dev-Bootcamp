public class Exams {
    public static void main(String[] args) {
        ...
        System.out.println(seats[0] + ", you will take 0");
        System.out.println(seats[1] + ", you will take 1");
        System.out.println(seats[2] + ", you will take 2");
        System.out.println(seats[3] + ", you will take 3");
        System.out.println(seats[4] + ", you will take 4");
